...
module.exports = {
    ...
    getOneTodoDB: async (req, res) => {
        ...
        try {
            ...
            if (!result[0][0]) {
                return res.status(400).json({ error: "la tache recherchée n'existe pas..." });
            } else {
                return res.status(200).json({ success: "voici la tache recherchée", result: result[0] });
            }
    ...
    deleteOneTodoDB: async (req, res) => {
        ...
        try {
            ...
            if (deleteTodo.affectedRows != 0) {
                return res.status(200).json({ success: "la tache est supprimé", result: result[0] });
            } else {
                return res.status(400).json({ error: "la tache n'existe pas, impossiblee de la supprimer..." });
            }
    ...
    updateOneTodoDB: async (req, res) => {
        ...
        try {
            ...
            if (task_desc && attribute_to) {
                ...
                return res.status(200).json({ success: "voici les résultats", result: result[0] });
